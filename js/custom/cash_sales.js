			  ...
			  $.post(site_url+"/sales/get_cust_id/",{cust_name:obj},function(data){
				 // alert(data);
						...
						$.post(site_url+"/sales/get_indent_limit/",{cust_id:data},function(result){
							...
							document.getElementById('indent_available').innerHTML=indent_available;
