...
function addrow(){
	...
	var cntinc=++cnt;
	$('.pet_pur_tbl ').append("<tr align='center'><td><select name='item"+cntinc+"' id='item"+cntinc+"' style='width:100%;' ></select></td><td><input type='text' name='qty"+cntinc+"' id='qty"+cntinc+"' style='width:50px;text-align:right' value='0'   onkeyup='calculate_amount(this.value,"+cntinc+")'/></td><td><input type='text' id='val"+cntinc+"' name='val"+cntinc+"' style='width:70px;text-align:right'  value='0' onblur='javascript:tot_amt(this.value,"+cntinc+")'/></td><td><input type='text' id='inv_den"+cntinc+"' name='inv_den"+cntinc+"' style='width:50px;text-align:right'  value='0' onchange=''/></td><td><input type='text' id='del_den"+cntinc+"' name='del_den"+cntinc+"' style='width:50px;text-align:right'  value='0'  onblur='check_density(this.value,"+cntinc+")'/></td></tr>");
...
function addanotherrow()
{
		...
		$('.billtable',updatepop.document).append("<tr><td><select name='item"+cntinc+"' id='item"+cntinc+"' style='width:100%;' ></select></td><td><input type='text' name='qty"+cntinc+"' id='qty"+cntinc+"'  style='width:50px;text-align:right' value='0'  onkeyup='javascript:opener.calculate_amount_pop(this.value,"+cntinc+")' /></td><td><input type='text' id='amt"+cntinc+"' name='amt"+cntinc+"' style='width:70px;text-align:right'  value='0' onchange='javascript:opener.get_tot_amt()' /></td><td><input type='text' id='inv_den"+cntinc+"' name='inv_den"+cntinc+"' style='width:50px;text-align:right'  value='0'/></td><td><input type='text' id='del_den"+cntinc+"' name='del_den"+cntinc+"' style='width:50px;text-align:right'  value='0'  onblur='javascript:opener.check_density_pop(this.value,1)'/></td></tr>");
...
function addanotherrow_other()
{
		...
		var cntinc=++cnt;
		//updatepop.document.getElementById('billtable').innerHTML +=("<tr><td><select name='item"+cntinc+"' id='item"+cntinc+"' style='width:100%;' ></select></td><td><input type='text' name='qty"+cntinc+"' id='qty"+cntinc+"'  style='width:50px;text-align:right' value='0' /></td><td><input type='text' id='amt"+cntinc+"' name='amt"+cntinc+"' style='width:70px;text-align:right'  value='0' onchange='javascript:opener.tot_amt(this.value,"+cntinc+")' /></td><td><input type='text' id='inv_den"+cntinc+"' name='inv_den"+cntinc+"' style='width:50px;text-align:right'  value='0'/></td><td><input type='text' id='del_den"+cntinc+"' name='del_den"+cntinc+"' style='width:50px;text-align:right'  value='0' onchange=''/></td></tr>");
		$('.billtable',updatepop.document).append("<tr><td><select name='item"+cntinc+"' id='item"+cntinc+"' style='width:100%;' onchange='javascript:opener.edit_page_cal_amt()'></select></td><td><input type='text' name='qty"+cntinc+"' id='qty"+cntinc+"'  style='width:50px;text-align:right' value='0' onchange='javascript:opener.edit_page_cal_amt()'/></td><td><input type='text' id='rate"+cntinc+"' name='rate"+cntinc+"' style='width:50px;text-align:right'  value='0'  onchange='javascript:opener.edit_page_cal_amt()'/></td><td><input type='text' id='amt"+cntinc+"' name='amt"+cntinc+"' style='width:70px;text-align:right'  value='0' onchange='javascript:opener.edit_page_cal_amt()' /></td></tr>");
		updatepop.document.getElementById('item'+cntinc).innerHTML=updatepop.document.getElementById('item1').innerHTML;
		updatepop.document.getElementById('item'+cntinc).focus();
		updatepop.document.getElementById('count').value=cntinc;
}
...
function addnewrow(){
	...
	var cntinc=++cnt;
	$('.tank_split_table ').append("<tr align='center'><td><select name='tnk"+cntinc+"' id='tnk"+cntinc+"' style='width:100%' onblur='javascript:get_tnk_pdt(this.value,"+cntinc+")' ></select></td><td><input type='text' id='pdt"+cntinc+"' name='pdt"+cntinc+"' style='width:70px;'  value='' /></td><td><input type='text' id='ltrs"+cntinc+"' name='ltrs"+cntinc+"' style='width:70px;text-align:right'  value='0' /></td></tr>");
...
function cal_amt(obj,id){
	...
	document.getElementById("cash_disc_amt").value=cash_disc_amt.toFixed(3);
	var sch_disc=document.getElementById("sch_disc").value;
	var sch_disc_amt=(tot_amt*sch_disc/100);
	document.getElementById("sch_disc_amt").value=sch_disc_amt.toFixed(3);
	var vat=document.getElementById("vat").value;
	var vat_amt=(tot_amt*vat/100);
	document.getElementById("vat_amt").value=vat_amt.toFixed(3);
	var others=document.getElementById("other_amt").value;
	var grand_tot=+tot_amt - +cash_disc_amt - +sch_disc_amt + +vat_amt + +others;
	document.getElementById("grnd_tot").value=grand_tot.toFixed(3);
...
function edit_page_cal_amt(){
	...
	var sch_disc_amt=(tot_amt*sch_disc/100);
	updatepop.document.getElementById("sch_disc_amt").value=sch_disc_amt.toFixed(3);
	...
	updatepop.document.getElementById("cash_disc_amt").value=cash_disc_amt.toFixed(3);
	...
	updatepop.document.getElementById("vat_amt").value=vat_amt.toFixed(3);
	var others=updatepop.document.getElementById("other_amt").value;
	var grand_tot=+tot_amt - +cash_disc_amt - +sch_disc_amt + +vat_amt - +others;
	updatepop.document.getElementById("grnd_tot").value=grand_tot.toFixed(3);
...
function check_qty(obj,id){
	...
	function grand_tot(obj){
		...
		var sch_disc=document.getElementById("sch_disc").value;
		var sch_disc_amt=(tot_amt*sch_disc/100);
		document.getElementById("sch_disc_amt").value=sch_disc_amt;
		var sch_disc_amt1=+tot_amt- +sch_disc_amt;
		var cash_disc=document.getElementById("cash_disc").value;
		var cash_disc_amt=(sch_disc_amt1*cash_disc/100);
		document.getElementById("cash_disc_amt").value=cash_disc_amt;
		var cash_disc_amt1=+sch_disc_amt1- +cash_disc_amt;
		var vat=document.getElementById("vat").value;
		var vat_amt=(cash_disc_amt1*vat/100);
		...
		var others=document.getElementById("other_amt").value;
		var grand_tot=+tot_amt - +cash_disc_amt - +sch_disc_amt + +vat_amt - +others;
		document.getElementById("grnd_tot").value=grand_tot;
	...
	function showpurchasedetails_other(voucherversion)
	{
	 ...
	 function edit_page_cur_amt(){
			...
			var sch_disc_amt1=tot_amt-sch_disc_amt;
			var sch_disc=(sch_disc_amt*100/tot_amt);
			updatepop.document.getElementById("sch_disc").value=sch_disc.toFixed(3);
			var cash_disc_amt=updatepop.document.getElementById("cash_disc_amt").value;
			var cash_disc_amt1=sch_disc_amt1-cash_disc_amt;
			var cash_disc=(cash_disc_amt*100/sch_disc_amt1);
			updatepop.document.getElementById("cash_disc").value=cash_disc.toFixed(3);
			var vat_amt=updatepop.document.getElementById("vat_amt").value;
			var vat_amt1=cash_disc_amt1+vat_amt;
			var vat=(vat_amt*100/cash_disc_amt1);
			updatepop.document.getElementById("vat").value=vat.toFixed(3);
			var others=updatepop.document.getElementById("other_amt").value;
			var grand_tot=+tot_amt - +sch_disc_amt- +cash_disc_amt+ +vat_amt+ +others;
			updatepop.document.getElementById("grnd_tot").value=grand_tot.toFixed(3);
