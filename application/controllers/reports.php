...
function pet_pur_dwnld($params){
	...
	function pet_reg_dwnld($params){
		...
		$data=$this->Reports_model->get_pet_bills($sdate,$edate);
	...
	function oth_reg_dwnld($params){
		...
		$data=$this->Reports_model->get_other_bills($sdate,$edate);
...
function pet_bill_register()
	...
	{
		$info = $this->input->post();
		$data["pet_bills"]=$this->Reports_model->get_pet_bills($info["sdate"],$info["edate"]);
		//$data["pdt_type"]=$info["product_type"];
	...
	{
		$info = $this->input->post();
		$data["other_bills"]=$this->Reports_model->get_other_bills($info["sdate"],$info["edate"]);
		//$data["pdt_type"]=$info["product_type"];
