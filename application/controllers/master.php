<?php
	...
	function customer_details()
	{
		...
		$this->master_model->insert_customerdtls($cust_name,$addr,$ph_num,$tin,$vehicle,$indent_no_start,$indent_no_end,$current_custid,$next_custid,$initial_deposit,$indent_limit,$open_bal);
	...
	function customer_info_update(){
		...
		$collect = $this->input->post();
		$this->master_model->update_customer_info($collect["cust_name"],$collect["cust_id"],$collect["addr"],$collect["phone_number"],$collect["tin"],$collect["vehicle_number"],$collect["indent_start_no"],$collect["indent_end_no"],$collect['initial_deposit'],$collect['indent_limit'],$collect['open_bal']);	
