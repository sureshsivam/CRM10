...
class Cumulative_Sales_stmt_xl_rpt{
       ...
       print("<td width='23%' align='center'>Indent Sales</td>");
       print("<td width='22%' align='center'>Credit Card Sales</td>");
       print("<td width='10%' align='center'>XtraReward Card Sales</td>");
       print("<td width='10%' align='center'>XtraPower Card Sales</td>");
       print("<td width='15%' align='center'>Easy Fuel Sales</td>");
       print("<td width='15%' align='center'>Cheque Sales</td>");
       print("<td width='15%' align='center'>Cash Sales</td>");
       print("<td width='15%' align='center'>Total Sales</td>");
       print("</tr>");
       $old_date='';
       $t_indent_sales=0;
       $t_credit_sales=0;
