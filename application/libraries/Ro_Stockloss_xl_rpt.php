...
class Ro_Stockloss_xl_rpt{
        ...
        header("Content-Disposition: attachment; filename=Stockloss_Stmt_for_".$month."-".$year.".xls");
        ...
        print("<td width='5%' align='center' colspan='13'>Stock Loss Statement Of Tank ".$tank." for the month of ".date('F-Y', strtotime("$year-$month-01"))."</td>");
        print("</tr>");
       print("<tr bgcolor='#518C9C'>");
	   ...
	   $loss_gain=$open_bal-$openrow["volume"];
