...
class Indent_stmt_report{
        ...
        print("<tr>");
        print("<p align='center' style='margin-top:10px;font-size:15pt;font-weight:bold;'>Indent Statements Report</p>"); 
        print("</tr>");
 ...
 print("<table  border='1' align='left' cellpadding='1' cellspacing='1'  class='alt_row' style='border-collapse:collapse;'>");
      ...
      foreach($data as $row) {
             ...
             print("<td width='8%' align='center'>".$row["bill_date"]."</td>");
             print("<td width='24%' align='center'>".$row["customer_name"]."</td>");
             print("<td width='24%' align='center'>".$row["tin"]."</td>");
             print("<td width='10%' align='center'>".$row["from_date"]."</td>");
             print("<td width='10%' align='center'>".$row["to_date"]."</td>");
