...
class stock_stmt_xl_rpt{
        ...
        header("Content-Disposition: attachment; filename=Stock_statement from ".$sdate." to ".$edate.".xls");
        ...
        print("<td width='5%' align='center' colspan='13'>Stock_statement from ".$sdate." to ".$edate."</td>");
        print("</tr>");
        print("</table>");
      ?>
      <?php if($cat=='all' || $cat=='FUEL'){?>
           ...
           <table border="1" width="100%" id="oil_heading_table" style="display:none;border-collapse:collapse;">
			...
			<td align="center" width="10%" >Closing Stock</td>
             ...
             print("</tr>");
              ...
              print("</table>");?>
              <?php }?>
               <?php if($cat=='all' || $cat=='2T_OIL_LOOSE'){?>
