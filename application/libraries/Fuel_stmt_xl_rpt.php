<?php
class Fuel_stmt_xl_rpt{

        public function Export($stmt_date){
        
        header("Content-type: application/vnd.ms-excel");
        header("Content-Disposition: attachment; filename=Fuel_Statement_of_".date('d-m-Y', strtotime($stmt_date)).".xls");
        ...
        print("<td width='5%' align='center' colspan='13'>Daily Fuel Statement for ".date('d-m-Y', strtotime($stmt_date))."</td>");
        print("</tr>");
		 print("<table width='1500px' border='1' align='left' cellpadding='1' cellspacing='1' style='width:1100px;overflow:scroll;border-collapse:collapse;'>");
	   	   print("<tr style='color:#4c0000;font-size:18px;font-weight:bold;margin:20px 0px 2px 20px;' align='center'><td colspan='18'>Pumpwise Petrol and Diesel Sales</td></tr>");
       ...
       */
       ...
       print("<input type='hidden' name='date_val' id='date_val' value='$stmt_date' />");
       $CI =& get_instance();
	   $CI->load->model('Statements_model');
	   $result = $CI->Statements_model->pumpwise_total('I',$stmt_date);
       if(!empty($result)){
       print("<tr class='td_rows'>");
       print("<td width='5%' align='left' colspan='2'>Shift I</td>");
       ...
       $CI =& get_instance();
	   $CI->load->model('Statements_model');
	   $result = $CI->Statements_model->pumpwise_total('II',$stmt_date);
       if(!empty($result)){
       print("<tr class='td_rows'>");
       print("<td width='5%' align='left' colspan='2'>Shift II</td>");
       print("<td width='8%' align='center' colspan='16'></td>");
       print("</tr>");
       ...
       $CI =& get_instance();
	   $CI->load->model('Statements_model');
	   $result = $CI->Statements_model->pumpwise_total('III',$stmt_date);
       if(!empty($result)){
       print("<tr class='td_rows'>");
       print("<td width='5%' align='left' colspan='2'>Shift III</td>");
       print("<td width='8%' align='center' colspan='16'></td>");
       print("</tr>");
       ...
       $CI =& get_instance();
	   $CI->load->model('Statements_model');
	   $result = $CI->Statements_model->loose_oil_total('I',$stmt_date);
	   if(!empty($result)){
	   $lo_ctr++;
       ...
       print("<tr style='color:#4c0000;font-size:18px;font-weight:bold;margin:20px 0px 2px 20px;' align='center'><td colspan='18'>2T Loose Oil Sales</td></tr>");
     ...
     /*  
       ...
       */
	   ...
	   $result = $CI->Statements_model->loose_oil_total('II',$stmt_date);
	   if(!empty($result)){
	   $lo_ctr++;
	    if($lo_ctr==1){
       print("<table width='1500px' border='1' align='left' cellpadding='1' cellspacing='1' style='width:1100px;overflow:scroll;margin-top:30px;border-collapse:collapse;'>");
	  ...
	  /* print("<tr class='td_rows'>");
	   ...
	   $result = $CI->Statements_model->loose_oil_total('III',$stmt_date);
	   if(!empty($result)){
	   $lo_ctr++;
       ...
       */
	   ...
	   if($lo_ctr>0){
	   	print("<tr class='td_rows'>");
	   print("<td width='5%' align='center'>Total</td>");
       print("<td width='7%' align='center'></td>");
       print("<td width='7%' align='center'></td>");
       print("<td width='7%' align='center'></td>");
       print("<td width='7%' align='center'>".round($lo_diff_qty,3)."</td>");
       ...
       $o_ch_rs=0;
        ...
        $CI =& get_instance();
	   $CI->load->model('Statements_model');
	   $result = $CI->Statements_model->other_pdt_tot($stmt_date);
       if(!empty($result)){
       	
       
       print("<table width='1700px' border='1' align='left' cellpadding='1' cellspacing='1' style='width:1100px;overflow:scroll;margin-top:30px;border-collapse:collapse;'>");
       print("<tr style='color:#4c0000;font-size:18px;font-weight:bold;margin:20px 0px 2px 20px;' align='center'><td colspan='18'>Other Products Sales</td></tr>");
       ...
       print("<td width='10%' align='center' rowspan='1' colspan='3' valign='center'>XtraPower Card Sales</td>");
       ...
       print("</tr>");
       print("<tr bgcolor='#518C9C' id='hdr_row_4' style='color:white;border-right:1px solid white;border-top:1px solid white; '>");
       ...
       print("<td width='5%' align='center' rowspan='1' colspan='1' valign='center'>Value (Rs)</td>"); 
       print("<td width='5%' align='center' rowspan='1' colspan='1' valign='center'>Ltr</td>");
       print("<td width='5%' align='center' rowspan='1' colspan='2' valign='center'>Value (Rs)</td>");
       print("<td width='5%' align='center' rowspan='1' colspan='1' valign='center'>Ltr</td>");
       print("<td width='5%' align='center' rowspan='1' colspan='1' valign='center'>Value (Rs)</td>");
       print("<td width='5%' align='center' rowspan='1' colspan='1' valign='center'>Ltr</td>");
       print("<td width='5%' align='center' rowspan='1' colspan='1' valign='center'>Value (Rs)</td>");
       ...
       print("<td width='5%' colspan='2' align='center'>".round($openrow["fs_rs"],3)."</td>");
       ...
       print("<td width='5%' colspan='2' align='center'>".round($o_fs_rs,3)."</td>");
       ...
       print("<table width='1500px' border='1' align='left' cellpadding='1' cellspacing='1' style='width:1100px;overflow:scroll;margin-top:30px;border-collapse:collapse;'>");
       print("<tr style='color:#4c0000;font-size:18px;font-weight:bold;margin:20px 0px 2px 20px;' align='center'><td colspan='19'>Cumulative Petrol and Diesel Sales</td></tr>");
       print("<tr bgcolor='#518C9C' id='hdr_row_5' style='color:white;border-right:1px solid white; '>");
       print("<td width='10%' align='center' rowspan='2' valign='center'>Product Name</td>");
       print("<td width='10%' align='center' rowspan='1' colspan='2' valign='center'>Total Sales</td>");
       print("<td width='10%' align='center' rowspan='1' colspan='2' valign='center'>Test Litres</td>");
       print("<td width='10%' align='center' rowspan='1' colspan='2' valign='center'>Indent Sales</td>");
       print("<td width='10%' align='center' rowspan='1' colspan='2' valign='center'>Credit Card Sales</td>");
       ...
       print("<td width='10%' align='center' rowspan='1' colspan='2' valign='center'>Cash Sales</td>");
       print("</tr>");
       print("<tr bgcolor='#518C9C' id='hdr_row_6' style='color:white;border-right:1px solid white;border-top:1px solid white; '>");
       print("<td width='5%' align='center' rowspan='1' colspan='1' valign='center'>Ltr</td>");
       print("<td width='5%' align='center' rowspan='1' colspan='1' valign='center'>Value (Rs)</td>");
       print("<td width='5%' align='center' rowspan='1' colspan='2' valign='center'>Ltr</td>");
	   print("<td width='5%' align='center' rowspan='1' colspan='1' valign='center'>Ltr</td>");
       print("<td width='5%' align='center' rowspan='1' colspan='1' valign='center'>Value (Rs)</td>"); 
       print("<td width='5%' align='center' rowspan='1' colspan='1' valign='center'>Ltr</td>");
       print("<td width='5%' align='center' rowspan='1' colspan='1' valign='center'>Value (Rs)</td>"); 
       ...
       print("<td width='10%' align='center' colspan='2'>".round($p_test_ltrs,3)."</td>");
       ...
       print("<td width='10%' align='center' colspan='2'>".round($d_test_ltrs,3)."</td>");
       ...
       print("<td width='10%' align='center' colspan='2'>".round($pd_test_ltrs,3)."</td>");
       ...
       print("<tr bgcolor='#518C9C' id='hdr_row_7' style='color:white;border-right:1px solid white; '>");
