...
class Shift_close_xl_rpt{

        public function Export($param){
        $form_data=explode("::", $param);
		$acct_date=$form_data[0];
		$counter=$form_data[1];
		$shift=$form_data[2];
        header("Content-type: application/vnd.ms-excel");
        header("Content-Disposition: attachment; filename=Shift_Close_Sales_Report-".$counter."-".$shift."-".$acct_date.".xls");
       ...
       print("<tr><td width='100%' align='center' colspan='16' style='font-weight:bolder;font-size:20px;'>Sales Report of Counter-".ucfirst($counter)." for Shift $shift on $acct_date</td></tr>");
       ...
       print("<td width='5%' align='center'>MRP(Rs)</td>");
       ...
       print("<input type='hidden' name='date_val' id='date_val' value='$acct_date' />");
       $CI =& get_instance();
	   $CI->load->model('Reports_model');
	   $result = $CI->Reports_model->shift_petrol_sales($acct_date,$shift,$counter);
       if(!empty($result)){
       print("<tr class='td_rows'>");
       print("<td width='5%' align='left' colspan='2'>Petrol/Diesel Sales</td>");
       print("<td width='8%' align='center' colspan='16'></td>");
       print("</tr>");
       ...
       print("<td width='5%' align='center'>".round($openrow["rate"],3)."</td>");
       ...
       if($openrow["Indent_sales"]==''){
        ...
        $temp_is_rs=$indent_sales*$openrow["rate"];
        $p_is_rs+=$temp_is_rs;
       ...
       $temp_cs_rs=$credit_sales*$openrow["rate"];
       $p_cs_rs+=$temp_cs_rs;
       ...
       $temp_fs_rs=$fleet_sales*$openrow["rate"];
       $p_fs_rs+=$temp_fs_rs;
       ...
       $p_xr_qty+=$xr_sales;
       $temp_xr_rs=$xr_sales*$openrow["rate"];
       $p_xr_rs+=$temp_xr_rs;
       ...
       $p_ef_qty+=$ef_sales;
       $temp_ef_rs=$ef_sales*$openrow["rate"];
       $p_ef_rs+=$temp_ef_rs;
       ...
       $p_ch_qty+=$ch_sales;
       $temp_ch_rs=$ch_sales*$openrow["rate"];
       $p_ch_rs+=$temp_ch_rs;
       ...
       $temp_bill_cs_rs=$cash_sales*$openrow["rate"];
       ...
       $temp_tot_cash_rs=$tot_cash_sales*$openrow["rate"];
       ...
       print("<tr bgcolor='#518C9C' id='hdr_row_2' style='color:white;border-right:1px solid white; '>");
       print("<td width='5%' align='center'>Pump No</td>");
       print("<td width='7%' align='center'>Product Name</td>");
       print("<td width='7%' align='center'>Opening Reading</td>");
       print("<td width='7%' align='center'>Closing Reading</td>");
       ...
       $CI =& get_instance();
	   $CI->load->model('Reports_model');
	   $result = $CI->Reports_model->shift_loose_oil_sales($acct_date,$shift,$counter);
       if(!empty($result)){
       print("<tr class='td_rows'>");
       print("<td width='5%' align='left' colspan='2'>2T LOOSE OIL</td>");
       print("<td width='8%' align='center' colspan='16'></td>");
       print("</tr>");
       ...
       $o_ch_rs=0;
        ...
        $CI =& get_instance();
	   $CI->load->model('Reports_model');
	   $result = $CI->Reports_model->shift_other_pdts_sales($acct_date,$shift,$counter);
       if(!empty($result)){
       	
       
       print("<table width='1500px' border='1' align='left' cellpadding='1' cellspacing='1' style='width:1100px;overflow:scroll;margin-top:30px;border-collapse:collapse;'>");
       print("<tr bgcolor='#518C9C' id='hdr_row_3' style='color:white;border-right:1px solid white; '>");
       print("<td width='10%' align='center' rowspan='2' valign='center'>Product Name</td>");
       print("<td width='15%' align='center' rowspan='1' colspan='2' valign='center'>Total Sales</td>");
       print("<td width='15%' align='center' rowspan='1' colspan='2' valign='center'>Cash Sales</td>");
       print("<td width='15%' align='center' rowspan='1' colspan='2' valign='center'>Indent Sales</td>");
       print("<td width='15%' align='center' rowspan='1' colspan='2' valign='center'>Credit Card Sales</td>");
       print("<td width='15%' align='center' rowspan='1' colspan='2' valign='center'>XtraPower Card Sales</td>");
       print("<td width='15%' align='center' rowspan='1' colspan='2' valign='center'>XtraReward Card Sales</td>");
       print("<td width='15%' align='center' rowspan='1' colspan='2' valign='center'>Easy Fuel Sales</td>");
       print("<td width='15%' align='center' rowspan='1' colspan='2' valign='center'>Cheque Sales</td>");
       print("</tr>");
       print("<tr bgcolor='#518C9C'  id='hdr_row_4' style='color:white;border-right:1px solid white; '>");
       print("<td width='7.5%' align='center' rowspan='1' colspan='1' valign='center'>Ltr</td>");
       print("<td width='7.5%' align='center' rowspan='1' colspan='1' valign='center'>Value (Rs)</td>");
	   print("<td width='7.5%' align='center' rowspan='1' colspan='1' valign='center'>Ltr</td>");
       print("<td width='7.5%' align='center' rowspan='1' colspan='1' valign='center'>Value (Rs)</td>"); 
       print("<td width='7.5%' align='center' rowspan='1' colspan='1' valign='center'>Ltr</td>");
       print("<td width='7.5%' align='center' rowspan='1' colspan='1' valign='center'>Value (Rs)</td>"); 
       ...
       print("<td width='7.5%' align='center'>".round($openrow["qty"],3)."</td>");
       $o_tot_sal_rs+=round($openrow["amt"],3);
       print("<td width='7.5%' align='center'>".round($openrow["amt"],3)."</td>");
       $o_bill_cash_qty+=round($openrow["bcs_qty"],3);
       print("<td width='7.5%' align='center'>".round($openrow["bcs_qty"],3)."</td>");
       $o_bill_cash_rs+=round($openrow["bcs_rs"],3);
       print("<td width='7.5%' align='center'>".round($openrow["bcs_rs"],3)."</td>");
       $o_is_qty+=round($openrow["is_qty"],3);
       print("<td width='7.5%' align='center'>".round($openrow["is_qty"],3)."</td>");
       $o_is_rs+=round($openrow["is_rs"],3);
       print("<td width='7.5%' align='center'>".round($openrow["is_rs"],3)."</td>");
       
       $o_cs_qty+=round($openrow["cs_qty"],3);
       print("<td width='7.5%' align='center'>".round($openrow["cs_qty"],3)."</td>");
       $o_cs_rs+=round($openrow["cs_rs"],3);
       print("<td width='7.5%' align='center'>".round($openrow["cs_rs"],3)."</td>");
       $o_fs_qty+=round($openrow["fs_qty"],3);
       print("<td width='7.5%' align='center'>".round($openrow["fs_qty"],3)."</td>");
       $o_fs_rs+=round($openrow["fs_rs"],3);
       print("<td width='7.5%' align='center'>".round($openrow["fs_rs"],3)."</td>");
       $o_xr_qty+=round($openrow["xr_qty"],3);
       print("<td width='7.5%' align='center'>".round($openrow["xr_qty"],3)."</td>");
       $o_xr_rs+=round($openrow["xr_rs"],3);
       print("<td width='7.5%' align='center'>".round($openrow["xr_rs"],3)."</td>");
       $o_ef_qty+=round($openrow["ef_qty"],3);
       print("<td width='7.5%' align='center'>".round($openrow["ef_qty"],3)."</td>");
       $o_ef_rs+=round($openrow["ef_rs"],3);
       print("<td width='7.5%' align='center'>".round($openrow["ef_rs"],3)."</td>");
       $o_ch_qty+=round($openrow["ch_qty"],3);
       print("<td width='7.5%' align='center'>".round($openrow["ch_qty"],3)."</td>");
       $o_ch_rs+=round($openrow["ch_rs"],3);
       print("<td width='7.5%' align='center'>".round($openrow["ch_rs"],3)."</td>");
       
       }
       print("<tr class='td_rows'>");
       print("<td width='10%' align='center'>Total</td>");
       
       print("<td width='7.5%' align='center'>".round($o_tot_sal_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_tot_sal_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_bill_cash_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_bill_cash_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_is_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_is_rs,3)."</td>");
       
       
       print("<td width='7.5%' align='center'>".round($o_cs_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_cs_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_fs_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_fs_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_xr_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_xr_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_ef_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_ef_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_ch_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($o_ch_rs,3)."</td>");
       print("</table>");
       }
       ...
       print("<td width='7.5%' align='center'>".round($p_saled_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_saled_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_tot_cash_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_tot_cash_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_is_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_is_rs,3)."</td>");
       
       
       print("<td width='7.5%' align='center'>".round($p_cs_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_cs_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_fs_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_fs_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_xr_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_xr_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_ef_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_ef_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_ch_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($p_ch_rs,3)."</td>");
       
       print("</tr>");
       print("<tr class='td_rows'>");
       print("<td width='10%' align='center'>Diesel</td>");
       
       print("<td width='7.5%' align='center'>".round($d_saled_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_saled_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_tot_cash_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_tot_cash_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_is_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_is_rs,3)."</td>");
       
       
       print("<td width='7.5%' align='center'>".round($d_cs_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_cs_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_fs_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_fs_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_xr_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_xr_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_ef_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_ef_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_ch_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($d_ch_rs,3)."</td>");
       
       print("</tr>");
       print("<tr class='td_rows'>");
       print("<td width='10%' align='center'>Total</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_saled_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_saled_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_tot_cash_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_tot_cash_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_is_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_is_rs,3)."</td>");
       
       
       print("<td width='7.5%' align='center'>".round($pd_cs_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_cs_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_fs_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_fs_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_xr_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_xr_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_ef_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_ef_rs,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_ch_qty,3)."</td>");
       
       print("<td width='7.5%' align='center'>".round($pd_ch_rs,3)."</td>");
       ...
       print("<tr bgcolor='#518C9C' id='hdr_row_5' style='color:white;border-right:1px solid white; '>");
