...
<tr>
	...
	<td>Mobile No</td>
	<td ><input name="mob_no" id="mob_no" type="text" style="width:100px;height:20px;" value='<?php echo $row->mobile_number?>' onkeyup=""></td>
</tr>
...
if($row->sale_mode == 'Cheque_sales'){
	...
	<select name='<?php echo "chequestatus"?>' id='<?php echo "chequestatus"?>' onchange='' <?php if($row->payment_mode=='CASH') echo "disabled" ?> >
	...
	print("<td>Cheque Status</td><td>"); ?>
	<select name='<?php echo "chequestatus".$count1?>' id='<?php echo "chequestatus".$count1?>' <?php if($row->payment_mode=='CASH') echo "disabled" ?> >
				<option value='NOT_CLEARED' <?php if($row->cheque_status=='NOT_CLEARED') echo "selected"?> >NOT CLEARED</option>
				<option value='CLEARED' <?php if($row->cheque_status=='CLEARED') echo "selected"?> >CLEARED</option>
				<option value='BOUNCED' <?php if($row->cheque_status=='BOUNCED') echo "selected"?> >BOUNCED</option>
		</select>	
