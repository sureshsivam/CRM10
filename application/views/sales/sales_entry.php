...
<div style="height:auto; background:#CCCCCC;width:550px;margin:20px 0px 0px 250px;border:1px solid black ;border-radius:10px;">
...
<td>Counter No</td>
	...
	<tr>
		...
		<td><input name="close_rdng" id="close_rdng" type="text" onblur="javascript:cal_sales('amt');" style="width:120px;height:20px;text-align:right;"></td>
	</tr>
	<tr>
		<td>Opening Meter Reading</td>
		<td><input name="open_rdng" id="open_rdng" type="text" style="width:120px;height:20px;text-align:right;" onblur="javascript:cal_sales('test_ltrs');"></td>
	</tr>
	<tr>
		<td>Sales Litres&nbsp;&nbsp;(Ltrs)</td>
		<td><input name="sales_ltrs" id="sales_ltrs" type="text" value='0' style="width:120px;height:20px;text-align:right;"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input name="net_sales" id="net_sales" type="text" value='0' style="width:120px;height:20px;text-align:right;"></td>
	</tr>
	<tr>
		<td>Rate &nbsp;&nbsp;(Rs)</td>
