...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Cancelled Petrol/Diesel Bill Details</center>
 </div>
...
<div style="height:auto;overflow:hidden; min-height:600px;background:#CCCCCC;width:1000px;margin:30px;border:1px solid black ;border-radius:10px;">
	...
	<input type="button" id="" class="" style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:get_cancelled_bills()"/>
	</div>
