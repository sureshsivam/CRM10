...
<div style="height:auto;overflow:hidden;min-height:600px; background:#CCCCCC;margin:30px;width:1000px;border:1px solid black ;border-radius:10px;">
...
?>
<div style='width:100%;min-height:60%;height:auto;'>
<div style="float:left;width:40%;">
<table style="margin-left:60px;padding:0px;float:left;margin-top:20px;" cellpadding="0" cellspacing="0">
<tr id="indent_cust_row" style="display:none;">
	<td>Indent Customers</td>
	<td><input name="ind_cust_name" id="ind_cust_name" type="text" style="width:200px;height:25px;" >
	</td>
</tr>
<tr id="cust_row">
	<td >Customer Name</td>
	<td ><input name="cust_name" id="cust_name" type="text" value ="" style="width:200px;height:25px;" onblur='get_other_pdts_customer_details(this.value)'></td>
	
</tr>
<tr id="same_name" style="display:none">
	<td>Customer Id</td>
		<td><select name="cust_id" id="cust_id" onchange="" onfocus="this.style.background='#F3F781'" style="width:300px;" onblur="fetch_other_pdts_customer(this.value)">
...
<tr>
	<td>Mobile No</td>
	<td ><input name="mob_no" id="mob_no" type="text" style="width:200px;height:25px;" onblur="javascript:focusId('item1')"></td>
...
<table id='indent_status_tbl' style="width:90%;margin-right:15px;margin-top:20px;display:none;"  border="1">
	...
	<tr><td>Entitled (Rs)</td><td id='indent_entitled'></td></tr>
	<tr><td>Taken (Rs)</td><td id='indent_taken'></td></tr>
	<tr><td>Available (Rs)</td><td id='indent_available'></td></tr>
</table>
</div>
</div>
...
<table border="0" id="billtable" style="width:70%;border-radius:15px;" class='bill_table'>
	...
	<tr align="center">
		...
		<td><input type="text" name="val1" id="val1" value="0" onkeyup="javascript:crt_amt(this.value,1,event)" onkeydown="addrowbyslash(event)"  onblur="" style="text-align:right;width:70px;font-size:18px;"/></td>
