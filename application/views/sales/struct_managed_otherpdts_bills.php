...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Other Products Bills Log</center>
 </div>
...
<div style="height:auto;overflow:hidden; min-height:600px;background:#CCCCCC;width:1000px;margin:30px;border:1px solid black ;border-radius:10px;">
	...
	<input type="button" id="" class="" style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:managed_other_pdts_bill_form()"/>
	</div>
...
<input type="text" class="input" name="billno" id="billno"  style="width:100px;height:18px;" onkeyup="javascript:searchbybillnolog()" >
...
<option value="Cheque_sales">Cheque Sales</option>
			...
			<td align="center" width="15%" style="border-right:1px solid white;"><span class="txt1_color">Customer Name</span></td>
