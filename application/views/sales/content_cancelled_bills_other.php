<?php 
   ...
   foreach( $cancelled_bills_other as $row) {
   		$counter++;     	
     	$rowid="row".$counter;
        ...
        print("<td width='5%'><a  href='javascript:show_cancelbill_details_other(\"".$row->bill_no."\");' id='edit_id'><font color=''>Click</font></a></td>");
		print("</tr>");    	
		 }
print("</table>");  
