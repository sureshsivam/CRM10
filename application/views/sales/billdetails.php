...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Petrol/Diesel Bill Details</center>
 </div>
...
<div style="height:auto;overflow:hidden; min-height:560px;background:#CCCCCC;width:1000px;margin:30px;border:1px solid black ;border-radius:10px;">
	...
	<input type="button" id="" class="" style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:PD_Editbill_form()"/>
...
<input type="text" class="input" name="billno" id="billno"  style="width:80px;height:18px;" onkeyup="javascript:searchbybillno()" >

<font size="2px" style="margin-left:20px; font-weight:bold">Indent Number</font>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" class="input" name="indent_no" id="indent_no"  style="width:80px;height:18px;" onkeyup="javascript:searchbyindentno()" >

<font size="2px" style="margin-left:20px; font-weight:bold">Customer Name</font>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" class="input" name="customer" id="customer"  style="width:80px;height:18px;" onkeyup="javascript:searchbycustomername()" >

<font size="2px" style="margin-left:20px; font-weight:bold">Vehicle Number</font>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" class="input" name="vehicle_number" id="vehicle_number"  style="width:80px;height:18px;" onkeyup="javascript:searchbyvehiclenumber()" >

<font size="2px" style="margin-left:20px; font-weight:bold">Sales Mode</font>&nbsp;&nbsp;&nbsp;&nbsp;
<select   class="dropdown" name="salesmode" id="salesmode" style="width:80px;height:20px;" onchange="javascript:searchbysalesmode()" >
...
<option value="Cheque_sales">Cheque Sales</option>
			...
			<td align="center" width="8%" style="border-right:1px solid white;"><span class="txt1_color">Indent No</span></td>
			...
			<td align="center" width="11%" style="border-right:1px solid white;"><span class="txt1_color">Sales Mode</span></td>
