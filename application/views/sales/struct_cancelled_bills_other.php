...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Cancelled Other Products Bill Details</center>
 </div>
 
<div style="height:auto;overflow:hidden; min-height:600px;background:#CCCCCC;width:1000px;margin:30px;border:1px solid black ;border-radius:10px;">
	...
	<input type="button" id="" class="" style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:get_cancelled_bills_other()"/>
	</div>
	
	
<div style="margin-left: 25px;margin-top:20px;margin-bottom:20px"><p style="display:inline;font-weight:bold;">Search by Bill No</p>&nbsp;&nbsp;&nbsp;&nbsp;
...
<option value="Cheque_sales">Cheque Sales</option>
			...
			<td align="center" width="9%" style="border-right:1px solid white;"><span class="txt1_color">Sales Mode</span></td>
			<td align="center" width="12%" style="border-right:1px solid white;"><span class="txt1_color">Bill Time</span></td>
			<td align="center" width="12%" style="border-right:1px solid white;"><span class="txt1_color">Cancelled Time</span></td>
			<td align="center" width="6%" style="border-right:1px solid white;"><span class="txt1_color">User</span></td>
			<td align="center" width="16%" style="border-right:1px solid white;"><span class="txt1_color">Reason</span></td>
			<td align="center" width="5%" style="border-right:1px solid white;"><span class="txt1_color">Details</span></td>
