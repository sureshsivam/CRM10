...
<?php 
$count0=0;
foreach($cancelled_bill_details_other as $row) { 
$count0++;
if($count0 ==1){ ?>
<div>
...
<tr>
	<td>Bill No</td>
	<td ><input readonly="readonly" name="bill_no" id="bill_no" readonly="readonly" type="text" style="width:100px;height:20px;" value='<?php echo $row->bill_no?>'></td>

	<td>Vehicle No</td>
	<td ><input readonly="readonly" name="veh_no" id="veh_no" type="text" style="width:100px;height:20px;" value='<?php echo $row->vehicle_no?>'></td>
</tr>
<tr>
	<td>Customer Name</td>
	...
	<td>Mobile No</td>
	<td ><input readonly="readonly" name="mob_no" id="mob_no" type="text" style="width:100px;height:20px;" value='<?php echo $row->mobile_no?>' onkeyup=""></td>
</tr>
...
<table border="0" id="billtable" style="width:80%;border-radius:15px;border-collapse:collapse;" class='bill_table'>
	...
	<?php 
	$count1=0;
	foreach($cancelled_bill_pdt_details_other as $details) {  
	$count1++;
		if ($count1 == 1 ){?>
	<tr> 
...
<p align="left" style="margin-left:445px;">Grand Total&nbsp;&nbsp;(Rs)<input readonly='readonly' type="text" name="total" id="total" value="<?php  echo $row->total_amt; ?>"  readonly="readonly"  style="width:100px;"/></p>
