...
<div style="height:auto;overflow:hidden; min-height:680px;background:#CCCCCC;width:1000px;margin:30px;border:1px solid black ;border-radius:10px;">
<table border="0" align="left" cellpadding="2" style="height:auto;width:100%;" class="tab_header_bg">
	<tr>
