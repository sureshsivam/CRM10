...
<tr><td >Vehicle No: <?php echo $bill['vehicle_no']; ?></td><td align="right">Counter :  <?php echo wordsToNumber($bill['counter']); ?></td></tr>
<?php if($bill['indent_no'] != "NULL"){
print("<tr><td >Indent No: ".$bill['indent_no']." </td><td align='right'></td></tr>"); }
?>
</table>
<table style="width:80%;margin: 0 auto;font-size:14;line-height:13px;">
<tr><td colspan='2' align="left"><?php echo "Mr./Mrs./M/s. ". $bill['customer_name'];?></td></tr>
</table>
<table style="width:100%;margin: 0 auto;margin-top:5px;margin-left:5px;font-size:14;line-height:24px;border-collapse:collapse;text-align:center;">
<tr><td width='40%' style='border:dashed 1px black;border-left:0px;'>PRODUCT</td><td width='20%' style='border:dashed 1px black;'>QTY</td><td width='20%' style='border:dashed 1px black;'>RATE(Rs)</td><td width='20%' style='border:dashed 1px black;border-right:0px;'>AMOUNT(Rs)</td></tr>
...
<tr><td width='40%'></td><td width='20%'></td><td width='20%'>Total(Rs)</td><td width='20%'><?php echo $bill['total_amt']; ?></td></tr>
