...
<div style="width:50%;height:auto;overflow:hidden;width:500px;min-height:350px; background:#CCCCCC;margin:10px 0px 0px 25%;border:1px solid black ;border-radius:10px;">
...
<td>Testing Litres (Ltrs)</td>
		<td align='left'><input name="test_litres" id="test_litres" type="text" style="width:100px;height:25px;" onkeypress="formsubmit_testbill(event)">
	</td>
</tr>
