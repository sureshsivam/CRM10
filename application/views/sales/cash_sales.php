...
<tr>
	<td>Mobile No</td>
	<td ><input name="mob_no" id="mob_no" type="text" style="width:200px;height:25px;" onblur="changefocus_topump()"></td>
...
<div style="min-height:150px;height:auto;margin:100px 100px 0px 120px;" align="center">
<table><tr><td></td><td>
<table border="0" align="center" id="billtable" style="width:70%;border-radius:15px;" class='bill_table'>
	...
	<tr style="padding:0px;height:50px;">
		...
		<td align="center"><input type="text" name="val1" id="val1" value="0" style="text-align:right;width:70px;font-size:18px;" onblur="" onkeyup="javascript:crt_amt(this.value,1,event)" onkeydown="addrowbyslash(event)"/></td>
...
<tr><td></td>
<td>
<table border="0" align="center"  style="width:70%;border-radius:15px;" id='twotoil_table'>
	<tr bgcolor='#006666' style='color:white;font-size:15px;font-weight:bolder;' align="center" >
	...
	<tr style="padding:0px;height:50px;">
		...
		<td align="center"><input type="text" name="2toilval" id="2toilval" value="0" style="text-align:right;width:70px;font-size:18px;" onblur="" onkeyup="javascript:crt_amt_2toil(this.value)" onkeydown="addrowbyslash(event)"/></td>
