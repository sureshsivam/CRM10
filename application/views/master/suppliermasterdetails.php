...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Supplier Details</center>
 ...
 <div style="height:auto;overflow:hidden;min-height:200px; background:#CCCCCC;margin:30px;width:1000px;border:1px solid black ;border-radius:10px;">
<div style="margin-left: 40px;margin-top:20px;font-weight:bold"><font size="2px">Search by Supplier</font>&nbsp;&nbsp;&nbsp;&nbsp;
...
<input type="button" value="Download Supplier Master" style="height:25px;width:200px;margin-left:150px;" onclick="javascript:supp_master_dwnld()">
			...
			<div style="margin-left: 850px;font-weight:bold"><a  href="<?php echo site_url("master/supplier_master");?>"><font color='#4c0000' size="3px" >Add New Supplier</font></a> </div>
			<hr width="100%">
