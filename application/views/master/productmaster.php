...
<table style="width:80%" border="0">
	<tr>
		<td  width="170px"><font class="font_align">Product Name</font></td>
	...
	<tr>
		<td width=""><font class="font_align">Product Rate</font></td>
		<td><input name="prod_rate" class="input" id="prod_rate" type="text" style="width:75px;height:18px; value=""></td>			
	</tr>
	<tr>
	...
	<tr style="display:none" id="stock_row">
		...
		<td><input name="stock" class="input" id="stock" type="text" style="width:75px;height:18px;" value=""></td>			
	</tr>
	<tr>
