...
<div style="margin-left: 40px;margin-top:20px;"><font size="2px">Sort by Product</font>&nbsp;&nbsp;&nbsp;&nbsp;
<select name="product" id="product"  style="width:125px;height:24px;" onchange="javascript:sortproduct()" class="dropdown">
			...
			<div style="margin-left: 850px;font-weight:bold"><a  href="<?php echo site_url("master/tank_master");?>"><font color='#4c0000' size="3px" >Add New Tank</font></a> </div>
			<hr width="100%">


			<div style="margin-left:30px;margin-bottom:10px;margin-right:30px;margin-top:10px;">
