...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Indent Customer Details</center>
 ...
 <div style="height:auto; background:#CCCCCC;width:1000px;margin:30px;border:1px solid black ;border-radius:10px;font-weight:bold">
<div style="margin-left: 40px;margin-top:20px;"><font size="2px" >Search by Customer Name</font>&nbsp;&nbsp;&nbsp;&nbsp;
...
<input type="text" class="input" name="vehicle_no" id="vehicle_no"  style="width:125px;height:24px;" onkeyup="javascript:searchbyvehicleno()" >
	<input type="button" value="Download Customer Master" style="height:25px;width:200px;margin-left:150px;" onclick="javascript:cust_master_dwnld()">
			</div>
			<div style="margin-left: 800px;font-weight:bold"><a  href="<?php echo site_url("master/customer_master");?>"><font color='#4c0000' size="3px" >Add New Indent Customer</font></a> </div>
			<hr width="100%">
			...
			<tr bgcolor="#559999">
			<td align="center" width="40%" style="border-right:1px solid white;"><span class="txt1_color">Customer Name</span></td>
			<td align="center" width="10%" style="border-right:1px solid white;"><span class="txt1_color">Vehicle</span></td>
			<td align="center" width="17%" style="border-right:1px solid white;"><span class="txt1_color">Phone Number</span></td>
...
<?php
  ...
  // print("<table width='100%' height='100%' border='1' align='left' cellpadding='1' cellspacing='1' style='margin-bottom:20px'>");
   foreach($customermaster as $row) {
        ...
        print("<td width='40%'  ><input type='text' height='' style='margin-left:0px;' class='plain_txt' id='$cust_id'  value=' $customer_name' /></td>");
        ...
        print("<td width='17%'><input type='text' style='' class='plain_txt' readonly='readonly' id='$phone_id' value='".$row->phone_number."' /></td>");
        $tin_id="tin".$counter;
