...
<div style="height:auto;overflow:hidden;min-height:400px; background:#CCCCCC;margin:30px;width:1000px;border:1px solid black ;border-radius:10px;">
			...
			<div style="margin-left: 20px;margin-top:20px;"><font size="2px">Sort by Product</font>&nbsp;&nbsp;&nbsp;&nbsp;
			<select name="product" id="product" class="dropdown" style="width:150px;height:20px;" onchange="javascript:sortproduct()">
			...
			<font size="2px" style="margin-left:30px;">Sort by Tank Number</font>&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<font size="2px" style="margin-left:30px;">Sort by Counter</font>&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<option value="Three">Three</option>
				...
				<input type="button" value="Download Pump Master" style="height:25px;width:150px;margin-left:40px;" onclick="javascript:pump_master_dwnld()">
			</div>
			<div style="margin-left: 850px;margin-top:20px;font-weight:bold;"><a  href="<?php echo site_url("master/index");?>"><font  color='#4c0000' size="3px" >Add New Pump</font></a> </div>
			<hr width="100%">
