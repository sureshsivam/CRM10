...
<table style="width:60%" border="0">
	<tr style="height:0%;">
		<td width="100px" ><font class="font_align">Tank Name</font></td>
	...
	<tr>
		<td ><font class="font_align">Capacity&nbsp;&nbsp;</font><span style="font-size:11px;" >(in litres)</span></td>
		<td colspan=""><input name="capacity" id="capacity"  class="input" type="text" style="width:75px;height:18px; value="">	
		Ltrs</td>	
	</tr>
	<tr>
