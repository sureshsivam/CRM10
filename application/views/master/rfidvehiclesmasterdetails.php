...
<div style="height:auto;overflow:hidden;min-height:300px; background:#CCCCCC;margin:30px;width:1000px;border:1px solid black ;border-radius:10px;">
<div style="margin-left: 40px;margin-top:20px;"><font size="2px">Search by Vehicle No</font>&nbsp;&nbsp;&nbsp;&nbsp;
