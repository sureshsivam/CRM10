...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Expenses Details</center>
 </div>
<div style="height:auto; background:#CCCCCC;width:1000px;margin:30px;border:1px solid black ;border-radius:10px;">
	...
	<p style="margin-left: 30px;font-size:15px;display:inline;font-weight:bold;">Expenses From</p>
	...
	<input type="button" id="" class="" style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:get_expenses_list()"/>
	<p id="cancel_msg" style="float:right;margin-right:40px;display:none;font-size:15px;color:red;">Cancelling...</p>
	</div>
	
	
<div style="margin-left: 25px;margin-top:20px;margin-bottom:20px;font-weight:bold"><font size="2px">Search by Bill No</font>&nbsp;&nbsp;&nbsp;&nbsp;
...
<input type="text" class="input" name="vendor" id="vendor"  style="width:125px;height:18px;" onkeyup="javascript:searchbyvendorname()" >
			...
			<td align="center" width="20%" style="border-right:1px solid white;"><span class='txt1_color'>Vendor Name</span></td>
			<td align="center" width="18%" style="border-right:1px solid white;"><span class='txt1_color'>Items Purchased</span></td>
