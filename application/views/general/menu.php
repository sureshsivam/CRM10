...
<li> <a href="javascript:void(0);" class="nav-top-item <?php if($menu=='master') echo "current"; ?> "> Masters</a>
  	<ul style="display: block;">
		...
		<!-- <li><a href="<?php echo site_url("master/customer_master_dtls");?>" <?php if ($submenu=='customer_master_dtls'){?>class="current"<?php }?>>Indent Customer Accounts Tree</a></li> -->
...
<li> <a href="javascript:void(0);" class="nav-top-item <?php if($menu=='sopages') echo "current"; ?> "> Sales Officer Pages</a>
  	<ul style="display: block;">
