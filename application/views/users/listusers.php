...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Users Details</center>
  ...
  <div style="height:auto;overflow:hidden;min-height:400px; background:#CCCCCC;margin:30px;width:1000px;border:1px solid black ;border-radius:10px;">
<div style="margin-left: 40px;margin-top:20px;"><font size="2px">Search by Name</font>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" class="input" name="user" id="user"  style="width:125px;height:24px;" onkeyup="javascript:searchbyname()" >
			</div>
			<div style="margin-left: 850px;color:#4c0000"><a  href="<?php echo site_url("users/add_new_user");?>"><font color='#4c0000' size="3px" >Add New User</font></a> </div>
			<hr width="100%">


			<div style="margin-left:30px;margin-bottom:10px;margin-right:20px;margin-top:10px;">
			<table border="0" width="100%">
			<tr bgcolor="#559999">
			<td align="center" width="17%" style="border-right:1px solid white;"><font color="white">Name</font></td>
			<td align="center" width="15%" style="border-right:1px solid white;"><font color="white">Username</font></td>
			<td align="center" width="15%" style="border-right:1px solid white;"><font color="white">Phone Number</font></td>
			<td align="center" width="8%" style="border-right:1px solid white;"><font color="white">User Role</font></td>
			<td align="center" width="10%" style="border-right:1px solid white;"><font color="white">Added By</font></td>
			<td align="center" width="15%" style="border-right:1px solid white;"><font color="white">Added Date</font></td>
			<td align="center" width="15%" style="border-right:1px solid white;"><font color="white">Last Login time</font></td>
			<td align="center" width="5%"><font color="white">Modify</font></td>
			</tr>
			</table>
