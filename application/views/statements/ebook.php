...
<div style="height:auto;overflow:hidden; background:#CCCCCC;margin:30px;width:1000px;min-height:600px;border:1px solid black ;border-radius:10px;">
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		...
		<td width="10%" align="LEFT"><input type='button' value='Get Report' onclick="javascript:get_ebook();" style="width:100px;"/> </td>
