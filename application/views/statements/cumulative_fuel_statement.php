...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Cumulative Fuel Statement</center>
 </div>
...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		<td width="5%" align="center" style="border-right:1px solid black;"><img width="25" id='cumulative_fuel_stmt_dwnld' height="20" src="<?php echo base_url(); ?>images/xls_download.png" alt="Download to XLS" /></td>
		<td width="35%" align="right">Cumulative Fuel Statement Between </td>
		<td width="10%"><input type="text" id="start_date"  class="datefld_txt" style="width:100px;"/></td>
		<td width="5%" align="center" style="">to</td>
		<td width="10%"><input type="text" id="end_date"  class="datefld_txt" style="width:100px;"/></td>
		<td width="27%" align="LEFT"><input type='button' value='Get Report' onclick="javascript:cumulative_fuel_stmt();" style="width:100px;"/> </td>
		<td width="8%" align="center" style="border-left:1px solid black;">
		<img  alt="print" id='print_cumulative_fuel_stmt' src="<?php echo base_url();?>images/printer1.png" title='Print'  width="35" height="35" />
		</td>
	</tr>
</table>
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/custom/fuel_stmt.js"></script>