...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Stock Statement</center>
 </div>
...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		<td width="5%" align="center" style="border-right:1px solid black;"><img width="25" id='stock_stmt_dwnld' height="20" src="<?php echo base_url(); ?>images/xls_download.png" alt="Download to XLS" /></td>
		<td width="23%" align="right">Stock From </td>
		...
		<td width="18%" align="right">Category</td>
		<td width="20%"><select name='category' id='category' style='width:200px;'>
							<option value='all'>All</option>
							<?php foreach($category as $cate_list){ ?>
							<option value="<?php echo $cate_list->category;?>" ><?php echo $cate_list->category;?></option>
							<?php } ?>
							
						</select>
		</td> 
		<td width="10%" align="LEFT"><input type='button' value='Get Report' onclick="javascript:get_stock_stmt();" style="width:100px;"/> </td>
		<td width="6%" align="LEFT"></td>
		<td width="8%" align="center" style="border-left:1px solid black;">
		<img  alt="print" id='print_stock_stmt' src="<?php echo base_url();?>images/printer1.png" title='Print'  width="35" height="35" />
		</td> 
	</tr>
</table>
<hr width="100%" >
