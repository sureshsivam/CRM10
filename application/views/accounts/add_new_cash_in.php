...
<div style="width:500px;height:auto;float:left;overflow:hidden;min-height:300px; background:#CCCCCC;margin:20px 0px 0px 8%;border:1px solid black ;border-radius:10px;">
...
<div style="width:300px;height:auto;overflow:hidden;min-height:100px;float:left; background:#CCCCCC;margin:20px 0px 0px 30px;border:1px solid black ;border-radius:10px;">
<table border="0" style="width:80%;margin-left:5%;padding:0px;float:left;margin-top:20px;" cellpadding="0" cellspacing="0">
<tr style='font-size:15px;'>
<td>Cash In Hand</td>
