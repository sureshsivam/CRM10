...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Stock Management</center>
	...
	<div style="height:auto; background:#CCCCCC;margin:20px 0px 0px 200px;width:600px;border:1px solid black ;border-radius:10px;">
	...
	<tr>
		<td width="150px"><font class="font_align">Tank Name</font></td>
		<td><select name="tank_no" id="tank_no" style="height:25px;width:100px;" onchange="javascript:get_product(this.value)" >
	...
	<tr>
		...
		<td><input name="product" class="input" id="product" type="text" style="width:125px;height:18px; value="" /></td>			
	</tr>
	<tr>
		<td width=""><font class="font_align">Volume</font></td>
		<td><input name="volume" class="input" id="volume" type="text" style="width:100px;height:18px; value="" /></td>			
	</tr>
	<tr>
		<td width=""><font class="font_align">Dip Level(cms)</font></td>
		<td><input name="dip_level" class="input" id="dip_level" type="text" style="width:100px;height:18px; value="" /></td>			
	</tr>
	<tr>
		<td width=""><font class="font_align">Water Level(cms)</font></td>
		<td><input name="water_level" class="input" id="water_level" type="text" style="width:100px;height:18px; value="" /></td>			
	</tr>
	<tr>
		<td width=""><font class="font_align">Density at 15&deg;C</font></td>
		<td><input name="density" class="input" id="density" type="text" style="width:100px;height:18px; value="" /></td>			
	</tr>
	<tr>
		<td width=""><font class="font_align">Actual Temp Density</font></td>
		<td><input name="act_density" class="input" id="act_density" type="text" style="width:100px;height:18px; value="" /></td>			
	</tr>
	<tr>
		<td width=""><font class="font_align">Actual Temp (&deg;C)</font></td>
		<td><input name="act_temp" class="input" id="act_temp" type="text" style="width:100px;height:18px; value="" /></td>			
	</tr>
	<tr>
