<?php 
$count0=0;
foreach($oldpurchasedetails as $row) { 
$count0++;
if($count0 ==1){ ?>
...
<?php 
	$count1=0;
	foreach($oldproductpurchasedetails as $details) {  
	$count1++;	?>
	<tr align="center"> 
...
<table border="0" id="tank_table" style="width:60%;border-radius:0px;border:0px solid green;" class='tank_table' align="center">
	...
	<tr align="center" bgcolor='#086A87' style='color:white;'>
