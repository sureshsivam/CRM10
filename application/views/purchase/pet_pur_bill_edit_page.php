...
<?php 
	...
	<tr align="center"> 
	   ...
	   <?php $del_den="del_den".$count1; ?>
		...
		<td><input type="text" name="<?php echo $qty;?>" id="<?php echo $qty;?>" value="<?php echo $details->quantity;?>" style="width:50px;text-align:right" onkeyup="javascript:opener.calculate_amount_pop(this.value,'<?php echo $count1; ?>')"/></td>
		<td><input type="text" name="<?php echo $amt;?>" id="<?php echo $amt;?>" value="<?php echo $details->amount;?>" style="width:70px;text-align:right" onchange=''/></td>
		<td><input type="text" name="<?php echo $inv_den;?>" id="<?php echo $inv_den;?>" value="<?php echo $details->inv_density;?>" style="width:50px;text-align:right" /></td>
		<td><input type="text" name="<?php echo $del_den;?>" id="<?php echo $del_den;?>" value="<?php echo $details->del_density;?>" style="width:50px;text-align:right"  onblur="javascript:opener.check_density_pop(this.value,'<?php echo $count1; ?>')" /></td>
...
<table border="0" id="tank_table" style="width:60%;border-radius:0px;border:0px solid green;" class='tank_table' align="center">
	...
	<td>
		<input type="text" name="<?php echo $ltrs;?>" id="<?php echo $ltrs;?>" value="<?php echo $res->quantity;?>" style="width:70px;text-align:right" onchange=""/></td>
