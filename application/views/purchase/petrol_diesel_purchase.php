...
<table border="0" id="pet_pur_tbl" style="width:90%;border-radius:0px;border:0px solid green;" class='pet_pur_tbl' align="center">
	...
	<tr align="center">
		...
		<td><input type="text" name="qty1" id="qty1" value="0" style="width:50px;text-align:right" onblur='javascript:check_qty(this.value,1)'  onkeyup="calculate_amount(this.value,'1')"/></td>
		<td><input type="text" name="val1" id="val1" value="0" style="width:70px;text-align:right" onblur="javascript:tot_amt(this.value,1)"/></td>
		<td><input type="text" name="inv_den1" id="inv_den1" value="0" style="width:50px;text-align:right" /></td>
		<td><input type="text" name="del_den1" id="del_den1" value="0" style="width:50px;text-align:right"  onblur="check_density(this.value,'1')"/></td>
...
<table border="0" id="tank_split_table" style="width:60%;border-radius:0px;border:0px solid green;" class='tank_split_table' align="center">
	...
	<td>
		<input type="text" name="ltrs1" id="ltrs1" value="0" style="width:70px;text-align:right" onchange=""/></td>
	</tr>
</table>
