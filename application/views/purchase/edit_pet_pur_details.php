...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Petrol/Diesel Purchase Details</center>
 ...
 <div style="height:auto;overflow:hidden; background:#CCCCCC;margin:30px;width:1000px;border:1px solid black ;border-radius:10px;">
	...
	<input type="button" id="" class="" style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:pet_pur_details()"/>
	</div>
...
<font size="2px" style="margin-left:40px">Invoice No</font>&nbsp;&nbsp;&nbsp;&nbsp;
