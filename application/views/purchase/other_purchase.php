...
<div style="height:auto; background:#CCCCCC;width:750px;margin:20px 0px 0px 150px;border:1px solid black ;border-radius:10px;">
<form name="other_pur_form" id="other_pur_form" method="post" action="<?php echo site_url('purchase/other_pur'); ?>" > 
<p style="height:40px;color:#4c0000;padding:20px 0px 0px 20px;" align="center"><span style="font-weight:bolder;font-size:20pt;">Purchase Information</span></p>
<hr width="100%">
...
<table border="0" id="oth_pur_tbl" style="width:80%;border-radius:15px;border:0px solid green;" class='oth_pur_tbl' align="center">
	...
	<tr align="center">
		...
		<td><input type="text" name="qty1" id="qty1" value="0" style="width:50px;text-align:right" onchange="javascript:cal_amt(this.value,1)"/></td>
		<td><input type="text" name="rate1" id="rate1" value="0" style="width:50px;text-align:right" onchange="javascript:cal_amt(this.value,1)"/></td>
		<td><input type="text" name="val1" id="val1" value="0" style="width:70px;text-align:right" onchange="javascript:cal_amt(this.value,1)"/></td>
...
<table  width="60%" style="" cellpadding="0" cellspacing="0" align="right" >
	...
	<tr >
		<td width="70%" align="right">Scheme Discount %<input type="text" name="sch_disc" id="sch_disc" value="0" onblur="javascript:grand_tot(this.value)"  style="width:40px;text-align:right;"/></td>
		<td width="30%" align="left"><input type="text" name="sch_disc_amt" id="sch_disc_amt" value="0"  style="width:80px;text-align:right;onblur="" onkeyup="javascript:crt_amt(this.value,1,event)" /></td>
	</tr>
	<tr >
		<td width="70%" align="right">Cash Discount % <input type="text" name="cash_disc" id="cash_disc" value="0" onblur="javascript:grand_tot(this.value)"   style="width:40px;text-align:right;"/></td>
		<td width="30%" align="left"><input type="text" name="cash_disc_amt" id="cash_disc_amt" value="0"  style="width:80px;text-align:right;onblur="" onkeyup="javascript:crt_amt(this.value,1,event)" /></td>
	</tr>
	<tr >
		<td width="70%" align="right">VAT Tax %<input type="text" name="vat" id="vat" value="0" onblur="javascript:grand_tot(this.value)" style="width:40px;text-align:right;"/></td>
		<td width="30%" align="left"><input type="text" name="vat_amt" id="vat_amt" value="0"  style="width:80px;text-align:right;onblur="" onkeyup="javascript:crt_amt(this.value,1,event)" /></td>
	</tr>
	<tr >
		<td width="70%" align="right">Others &nbsp;&nbsp;(Rs)</td>
		<td width="30%" align="left"><input type="text" name="other_amt" id="other_amt" value="0" onblur="javascript:grand_tot(this.value)" style="width:80px;text-align:right;"/></td>
	</tr>
