...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Other Products Purchase Details</center>
 ...
 <div style="height:auto;overflow:hidden; background:#CCCCCC;margin:30px;width:1000px;border:1px solid black ;border-radius:10px;">
	...
	<input type="button" id="" class="" style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:oth_pur_details()"/>
	</div>
	
<div style="margin-left: 25px;margin-top:20px;margin-bottom:20px;font-weight:bold"><p style="display:inline">Search by Bill No</p>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" class="input" name="inv_no" id="inv_no"  style="width:100px;height:18px;" onkeyup="javascript:searchbyinvno()" >
<font size="2px" style="margin-left:40px">Voucher No</font>&nbsp;&nbsp;&nbsp;&nbsp;
