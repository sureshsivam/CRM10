...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Petrol/Diesel Purchase Log</center>
 </div>
 <div style="height:auto;overflow:hidden; background:#CCCCCC;margin:30px;width:1000px;border:1px solid black ;border-radius:10px;">
	...
	<input type="button" id="" class="" style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:managed_retail_purchase_form()"/>
	</div>
	
	
<div style="margin-left: 25px;margin-top:20px;margin-bottom:20px;font-weight:bold"><font size="2px" >Search by Voucher No</font>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" class="input" name="voucher_no" id='voucher_no'  style="width:100px;height:18px;" onkeyup="javascript:searchbyvouchernoroman()" >
<font size="2px">Invoice No</font>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" class="input" name="inv_no" id="inv_no"  style="width:125px;height:18px;" onkeyup="javascript:searchbyinvno()" >
</div>
			...
			<tr bgcolor="#559999">
			<td align="center" width="11%" style="border-right:1px solid white;"><span class="txt1_color">Voucher No</span></td>
			<td align="center" width="17%" style="border-right:1px solid white;"><span class="txt1_color">Party Name</span></td>
			<td align="center" width="10%" style="border-right:1px solid white;"><span class="txt1_color">Invoice No</span></td>
			<td align="center" width="10%" style="border-right:1px solid white;"><span class="txt1_color">Invoice Date</span></td>
			<td align="center" width="10%" style="border-right:1px solid white;"><span class="txt1_color">Total</span></td>
			<td align="center" width="15%" style="border-right:1px solid white;"><span class="txt1_color">Added Date</span></td>
			<td align="center" width="12%" style="border-right:1px solid white;"><span class="txt1_color">Delivery Date</span></td>
			<td align="center" width="10%" style="border-right:1px solid white;"> <span class="txt1_color">User</span></td>
