...
<?php 
	...
	<tr align="center"> 
	   ...
	   <td><select name="<?php echo $item;?>" id="<?php echo $item; ?>" style='width:100%;' onchange='javascript:opener.edit_page_cal_amt()'>
		...
		<td><input type="text" name="<?php echo $qty;?>" id="<?php echo $qty;?>" value="<?php echo $details->quantity;?>" style="width:50px;text-align:right" onchange='javascript:opener.edit_page_cal_amt()'/></td>
		<td><input type="text" name="<?php echo $rate;?>" id="<?php echo $rate;?>" value="<?php echo $details->rate;?>" style="width:50px;text-align:right" onchange='javascript:opener.edit_page_cal_amt()'/></td>
		<td><input type="text" name="<?php echo $amt;?>" id="<?php echo $amt;?>" value="<?php echo $details->amount;?>" style="width:70px;text-align:right" onchange='javascript:opener.edit_page_cal_amt()'/></td>
		</tr>
		<?php }?>
...
<table  width="60%" style="" cellpadding="0" cellspacing="7px" align="right" >
	...
	<tr >
		<td width="70%" align="right">Scheme Discount %<input type="text" name="sch_disc" id="sch_disc" onchange='javascript:opener.edit_page_cal_amt()' value="<?php  echo $row->scheme_dis_per; ?>"  style="width:40px;text-align:right;"/></td>
		<td width="30%" align="left"><input type="text" name="sch_disc_amt" id="sch_disc_amt" onchange='javascript:opener.edit_page_cur_amt()'value="<?php  echo $row->scheme_discount; ?>" style="width:80px;text-align:right;"/></td>
	</tr>
	<tr >
		<td width="70%" align="right">Cash Discount % <input type="text" name="cash_disc" id="cash_disc" onchange='javascript:opener.edit_page_cal_amt()' value="<?php  echo $row->cash_dis_per; ?>"  style="width:40px;text-align:right;"/></td>
		<td width="30%" align="left"><input type="text" name="cash_disc_amt" id="cash_disc_amt" onchange='javascript:opener.edit_page_cur_amt()' value="<?php  echo $row->cash_discount; ?>"   style="width:80px;text-align:right;"/></td>
	</tr>
	<tr >
		<td width="70%" align="right">VAT Tax %<input type="text" name="vat" id="vat" value="<?php  echo $row->vat_tax_per; ?>" onchange='javascript:opener.edit_page_cal_amt()' style="width:40px;text-align:right;"/></td>
		<td width="30%" align="left"><input type="text" name="vat_amt" id="vat_amt"  onchange='javascript:opener.edit_page_cur_amt()' value="<?php  echo $row->vat_tax; ?>"  style="width:80px;text-align:right;"/></td>
	</tr>
	<tr >
		<td width="70%" align="right">Others &nbsp;&nbsp;(Rs)</td>
		<td width="30%" align="left"><input type="text" name="other_amt" id="other_amt" value="<?php  echo $row->others; ?>" onchange='javascript:opener.edit_page_cal_amt()' style="width:80px;text-align:right;"/></td>
	</tr>
