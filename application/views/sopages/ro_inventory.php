...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">RO Inventory Report</center>
 </div>
...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		<td width="5%" align="center" style="border-right:1px solid black;"><img width="25" id='ro_inventory_dwnld' height="20" src="<?php echo base_url(); ?>images/xls_download.png" alt="Download to XLS" /></td>
		<td width="35%" align="right">Inventory Report on </td>
		<td width="10%"><input type="text" id="start_date"  class="datefld_txt" style="width:100px;"/></td>
		<td width="42%" align="LEFT"><input type='button' value='Get Report' onclick="javascript:ro_inventory();" style="width:100px;"/> </td>
		<td width="8%" align="center" style="border-left:1px solid black;">
		<img  alt="print" id='print_ro_inventory' src="<?php echo base_url();?>images/printer1.png" title='Print'  width="35" height="35" />
		</td>
	</tr>
</table>
