...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Cumulative Sales Report</center>
 </div>
...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		...
		<td width="10%" align="LEFT"><input type='button' value='Get Report' onclick="javascript:get_cumulative_sales();" style="width:100px;"/> </td>
