...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Other Products Purchase Report</center>
 </div>
...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		<td width="5%" align="center" style="border-right:1px solid black;"><img width="25" id='oth_pur_dwnld' height="20" src="<?php echo base_url(); ?>images/xls_download.png" alt="Download to XLS" /></td>
		<td width="20%" align="right">Purchase From </td>
		...
		<td width="20%"><select name='supp_name' id='supp_name' style="width:120px;">
		...
		<td width="17%" align="LEFT"><input type='checkbox' name='show_det' id='show_det' value='show_details' class='' style='width:18px;height:18px;'/> <label for='show_det'>Show Details</label></td>
		<td width="10%" align="LEFT"><input type='button' value='Get Report' onclick="javascript:other_pur_report()" style="width:100px;"/> </td>
		
		<td width="8%" align="center" style="border-left:1px solid black;">
		<img  alt="print" id='print_oth_pur_rpt' src="<?php echo base_url();?>images/printer1.png" title='Print'  width="35" height="35" />
		</td>
	</tr>
</table>
