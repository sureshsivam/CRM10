...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		...
		<td width="29%" align="right">Testing Register From </td>
		...
		<td width="20%" align="LEFT"><input type='button' value='Get Report' onclick="javascript:get_test_report();" style="width:100px;"/> </td>
