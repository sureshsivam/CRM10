...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Other Products Bill Register</center>
 </div>
...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		<td width="5%" align="center" style="border-right:1px solid black;"><img width="25" id='oth_reg_dwnld' height="20" src="<?php echo base_url(); ?>images/xls_download.png" alt="Download to XLS" /></td>
		<td width="23%" align="right">Other Products Bills Register From </td>
		...
		<td width="10%" align="LEFT"><input type='button' value='Get Report' onclick="javascript:get_other_bill_register();" style="width:100px;"/> </td>
