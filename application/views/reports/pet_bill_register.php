...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		...
		<td width="23%" align="right">Petrol / Diesel Bills Register From </td>
		...
		<td width="10%" align="LEFT"><input type='button' value='Get Report' onclick="javascript:get_pet_bill_register();" style="width:100px;"/> </td>
