<?php
  print("<table  border='1' align='left' cellpadding='1' cellspacing='1'  class='alt_row' style='border-collapse:collapse;'>");
       ...
       print("<td width='10%' align='center'><span class='txt1_color'>Actiontime</span></td>");
       print("<td width='10%' align='center'><span class='txt1_color'>Bill_No</span></td>");
       print("<td width='10%' align='center'><span class='txt1_color'>Bill_Date</span></td>");
