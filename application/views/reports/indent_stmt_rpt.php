...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Indent Statements Report</center>
 </div>
...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		...
		<td width="23%" align="right"> From </td>
		...
		<td width="10%" align="LEFT"><input type='button' value='Get Report' onclick="javascript:indent_stmt_details();" style="width:100px;"/> </td>
		<td width="6%" align="LEFT"></td>
		<td width="8%" align="center" style="border-left:1px solid black;">
		<img  alt="print" id='print_indent_stmt_rpt' src="<?php echo base_url();?>images/printer1.png" title='Print'  width="35" height="35" />
		</td>
	</tr>
</table>
