...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		...
		<td width="23%" align="right">Select Date </td>
		...
		<td width="10%" align="LEFT"><input type='button' value='Get Report' onclick="javascript:shift_close_report();" style="width:100px;"/> </td>
