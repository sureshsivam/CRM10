<?php
       ...
       print("<tr><td width='100%' align='center' colspan='18' style='font-weight:bolder;color:#4c0000;font-size:20px;'>Sales Report of Counter-".ucfirst($counter)." for Shift $shift on $acct_date</td></tr>");
       ...
       print("</tr>");
       print("<tr bgcolor='#559999'  id='hdr_row_4' style='color:Black;border-right:1px solid Black; '>");
