...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Petrol/Diesel Sales Report</center>
 </div>
...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		<td width="5%" align="center" style="border-right:1px solid black;"><img width="25" id='pet_sal_dwnld' height="20" src="<?php echo base_url(); ?>images/xls_download.png" alt="Download to XLS" /></td>
		<td width="23%" align="right">Sales From </td>
		...
		<td width="10%"><select name='filter' id='filter'>
							<option value='allshift'>All Shift</option>
							<option value='I'>I Shift</option>
							<option value='II'>II Shift</option>
							<option value='III'>III Shift</option>
							<option value='date'>Datewise Cumulative</option>
							<option value='month'>Monthwise Cumulative</option>
						</select>
		</td> 
		
		<td width="10%" align="LEFT"><input type='button' value='Get Report' onclick="javascript:get_report();" style="width:100px;"/> </td>
		<td width="6%" align="LEFT"></td>
		<td width="8%" align="center" style="border-left:1px solid black;">
		<img  alt="print" id='print_pet_sale_rpt' src="<?php echo base_url();?>images/printer1.png" title='Print'  width="35" height="35" />
		</td>
	</tr>
</table>
