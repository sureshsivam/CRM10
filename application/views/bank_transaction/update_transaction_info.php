...
<tr>
	...
	<option value='FLEET' <?php if($row["transaction_type"]=='FLEET')echo "selected";?> >FLEET CARD SALES CLEARANCE</option>
...
<tr>
	<td>Amount</td>
		<td>
			<input name="amount" id="amount" type="text" style="width:100px;height:20px;" value='<?php echo $row["amount"]?>' onkeyup="">
		</td>
</tr>
<tr>
	<td>Remarks</td>
